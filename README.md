...
* Shared Kernel (In our case we use common `BaseValueIdType` as ValueObject type for domain models which identities of them should be immutable and globally unique like CustomerId, SuitAlterationId)
